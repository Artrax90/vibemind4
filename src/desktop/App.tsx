...
import { Network, Edit3, Eye, Search, X, Menu, AlertTriangle, Lock, Sparkles, BarChart3, Calendar, Hash, FileText, LayoutGrid, MessageSquare, PanelLeftOpen, ChevronLeft, ChevronRight, Bell, Plus, Repeat, Trash2 } from 'lucide-react';
            ...
            <motion.div key="calendar" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
              ...
              <AnimatePresence>
                {expandedDay && (() => {
                  ...
                  const dayNotes = notes.filter(n => ((n as any).created_at || (n as any).createdAt || '').startsWith(expandedDay) || ((n as any).updated_at || (n as any).updatedAt || '').startsWith(expandedDay));
